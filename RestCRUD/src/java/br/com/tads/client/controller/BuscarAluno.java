 ...
 * @author diullian
 */
@WebServlet(name = "BuscarAluno", urlPatterns = {"/buscarAluno"})
@Stateless
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getParameter("matricula") != null){
            ...
            if(matricula > 0){
                ...
                aluno = ac.getAlunoById(matricula);
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            request.getRequestDispatcher("/buscar_aluno.jsp").forward(request, response);
