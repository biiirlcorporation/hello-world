...
<head>
    ...
    <body>
         ...
         <div class="container">
           ...
           <div class="collapse navbar-collapse">
             <ul class="nav navbar-nav">
               ...
               <li class="active"><a href="/RestCRUD/buscarAluno">Buscar Aluno</a></li>
             </ul>
           </div><!--/.nav-collapse -->
         </div>
       </div>
       ...
       <div class="container" style="margin-top: 80px;">
            <h1>Buscar por matrícula</h1>
            
            <div class="well">
                <form method="post" action="/RestCRUD/buscarAluno">
                    <input type="text" name="matricula" id="matricula" placeholder="Buscar por Nr. Matrícula" />
